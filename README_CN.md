...
Egretia Engine包含了白鹭时代研发的遵循HTML5标准的游戏引擎，他包括 2D / 3D 渲染核心、EUI体系、音频管理、资源管理等游戏引擎的常用模块。
...
* 访问 [Egret Engine](http://www.egret.com/products/engine.html) 获取 Egretia 引擎的启动器
* 访问 [Egret Wing](http://www.egret.com/products/wing.html) 获取 Egretia IDE
* 访问 [Dragonbones Pro](http://dragonbones.com/cn/index.html) 获取 Egretia 骨骼动画工具
